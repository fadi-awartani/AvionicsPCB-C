...
int minmea_gettime(const struct minmea_date *date, const struct minmea_time *time_)
{
    ...
    tim.tm_year = 2000 + date->year - 1900;
    tim.tm_mon = date->month - 1;
    tim.tm_mday = date->day;
    tim.tm_hour = time_->hours;
    tim.tm_min = time_->minutes;
    tim.tm_sec = time_->seconds;
